    ...
    <div class="container" style="max-width: 64rem;">
        ...
        <div style="background-color: white; padding: 3rem; box-shadow: 0 20px 25px rgba(0, 0, 0, 0.15);">
            ...
            <div style="margin-bottom: 3rem;">
                <h3 style="font-size: clamp(1.875rem, 4vw, 2.25rem); color: var(--color-primary); margin-bottom: 2rem; border-bottom: 3px solid var(--color-primary); padding-bottom: 0.5rem;">
